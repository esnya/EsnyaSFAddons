...
namespace EsnyaAircraftAssets
{
    ...
    public class DFUNC_LandingLight : UdonSharpBehaviour
    {
        ...
        public void KeyboardInput() => SendCustomNetworkEvent(NetworkEventTarget.All, nameof(TurnOn));

        private bool GetTrigger()
        {
            if (Input.GetKey(desktopKey)) return true;
